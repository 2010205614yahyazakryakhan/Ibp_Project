...
//Inserting data's
    ...
    if ($conn->query($sql) === TRUE) {
        echo '<div class="alert alert-success" role="alert">Order successfully added.</div>';
    } else {
        echo '<div class="alert alert-danger" role="alert">An error occurred while adding the order: ' . $conn->error . '</div>';
    }
}
