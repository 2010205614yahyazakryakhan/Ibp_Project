...
<!-- Navbar -->
<header>
    <a href="#" class="logo"><img src="logo.png" alt="">YBY Restaurant Admin Panel</a>
    ...
    <ul class="navbar">
        ...
        <li><a href="view_rezervation.php"<?php if ($Admin == "view_rezervations") echo "active" ?> target="_blank">View
                Reservations</a></li>
